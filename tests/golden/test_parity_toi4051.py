...
def _run_new_code(golden: dict):
    """Run ValidationWorkspace on TOI-4051 stub data."""
...
@pytest.fixture(scope="module")
def new_toi4051_result(golden_toi4051: dict):
    return _run_new_code(golden_toi4051)


@pytest.mark.golden
def test_fpp_within_tolerance(new_toi4051_result, golden_toi4051: dict) -> None:
    """FPP matches golden value within atol=1e-4."""
    new_fpp = new_toi4051_result.fpp
...
@pytest.mark.golden
def test_nfpp_within_tolerance(new_toi4051_result, golden_toi4051: dict) -> None:
    """NFPP matches golden value within atol=1e-4."""
    new_nfpp = new_toi4051_result.nfpp
...
@pytest.mark.golden
def test_probs_sum_to_one(new_toi4051_result) -> None:
    """Relative probabilities sum to 1.0."""
    probs_df = _probs_df(new_toi4051_result.results)
...
def test_lnZ_within_rtol(
    new_toi4051_result, golden_toi4051: dict, scenario_id: str
) -> None:
